...
public class EditCommandParserTest {
    ...
    public void parse_multipleRepeatedFields_failure() {
        ...
        userInput = targetIndex.getOneBased() + PHONE_DESC_AMY + ROOM_DESC_AMY + EMAIL_DESC_AMY
        ...
        userInput = targetIndex.getOneBased() + INVALID_PHONE_DESC + INVALID_ROOM_DESC + INVALID_EMAIL_DESC
            + INVALID_PHONE_DESC + INVALID_ROOM_DESC + INVALID_EMAIL_DESC;
